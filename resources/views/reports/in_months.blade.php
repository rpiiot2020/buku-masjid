    ...
    <table class="table table-sm card-table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Balance per {{ Carbon\Carbon::parse($lastBankAccountBalanceOfTheMonth->date)->isoFormat('D MMMM Y') }} di BANK</td>
            ...
            <tr>
                ...
                <td>Remaining balance per {{ $lastMonthDate->isoFormat('D MMMM Y') }}</td>
...
{{--                <td class="text-center">Selisih saldo {{ $currentMonthEndDate->isoFormat('D MMMM Y') }}</td>--}}
                <td class="text-center">Balance Different {{ $currentMonthEndDate->isoFormat('D MMMM Y') }}</td>
                <td class="text-right">
                    @php
...
{{--                <td class="text-center">Total saldo akhir per {{ $currentMonthEndDate->isoFormat('D MMMM Y') }}</td>--}}
                <td class="text-center">Total balance by end {{ $currentMonthEndDate->isoFormat('D MMMM Y') }}</td>
                <td class="text-right">-</td>
                <td class="text-right">-</td>
                <td class="text-right">
